...
namespace Executors
{
    public class ProcessAdvanced : IDisposable
    {
        ...
        /// <returns></returns>
        public int Start(int timeLimit, int memoryLimit)
        {

            try
            {
                this.jobObject = new JobObjects.JobObject();
                this.jobObject.SetExtendedLimitInformation(JobObjects.PrepareJobObject.GetExtendedLimitInformation(timeLimit * 2, (int)Math.Round(memoryLimit * 1.5,0)));
                this.jobObject.SetBasicUiRestrictions(JobObjects.PrepareJobObject.GetUiRestrictions());
            ...
            {
                this.Kill();
                Debug.WriteLine("throw;throw;throw;");
                //throw;
                return 0;
            }
            return 1;
